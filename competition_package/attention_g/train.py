...
- **MODIFIED: Uses HuberLoss instead of MSELoss for robustness against outliers.**
"""
...
def main(args):
    ...
    # --- CHANGED: Use Huber Loss instead of MSELoss ---
...
if __name__ == '__main__':
    class Args:
        def __init__(self):
            self.data = '/kaggle/input/train-ds/train.parquet'
            self.seq_len = 150
            self.batch_size = 32
